...
@Component({
  selector: 'app-lead-creation-list',
  templateUrl: './lead-creation-list.component.html',
  styleUrls: ['./lead-creation-list.component.sass']
})
export class LeadCreationListComponent implements OnInit {
...
window.open(pdfurl,"_blank"); 
  ...
  view_leadinfo(myjson){
    ...
    this.router.navigate(['view-lead-creation'],  {state: myjson});
  }
}
