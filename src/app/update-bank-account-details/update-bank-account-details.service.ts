...
export class UpdateBankAccountDetailsService {
  ...
  Get_save_function(accountNumber, branchName, adress, finbankId, siteId, saleOwnerId,
    setoffTypeId, accountHolderName, ifscCode, finprojAccId, finprojAccMapId, adressid): Promise<any> {
    return new Promise((resolve, reject) => {
      const body = {
        "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
        "accountNumber": accountNumber,
