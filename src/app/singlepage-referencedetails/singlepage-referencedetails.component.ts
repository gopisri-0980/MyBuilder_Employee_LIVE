...
@Component({
  selector: 'app-singlepage-referencedetails',
  templateUrl: './singlepage-referencedetails.component.html',
  styleUrls: ['./singlepage-referencedetails.component.sass']
})
export class SinglepageReferencedetailsComponent implements OnInit {
  viewData:any;
  comment: any;
  ...
  //  alert(this.comment);
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if(resp.responseCode==200){
        swal("Good job!", "Your comment/status has been added.", "success");
