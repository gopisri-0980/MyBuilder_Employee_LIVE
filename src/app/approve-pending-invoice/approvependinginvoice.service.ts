...
export class ApprovependinginvoiceService {
  ...
  getApprovePendingInvoice(): Promise<any> {
    return new Promise((resolve, reject) => {
      var body = {
        ...
        "floorIds": [],
        "flatIds": [],
        "condition" : "approveModificationInvoices"
      }

      console.log(body);
      let url = this.cmn.commonUrl + "financial/getPendingModificationInvoices.spring";
      console.log(url);
