...
@Component({
  selector: 'app-singlepage-receipt-tds-view',
  templateUrl: './singlepage-receipt-tds-view.component.html',
  styleUrls: ['./singlepage-receipt-tds-view.component.sass']
})
export class SinglepageReceiptTdsViewComponent implements OnInit {
