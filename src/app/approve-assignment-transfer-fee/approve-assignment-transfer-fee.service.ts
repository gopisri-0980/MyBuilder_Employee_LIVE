...
export class ApproveAssignmentTransferFeeService {
  ...
  getApprovePendingInvoice(): Promise<any> {
    return new Promise((resolve, reject) => {
      var body = {
        ...
        "floorIds": [],
        "flatIds": [],
        "condition": "approveAssignmentTransferFeeInvoices"
      }

      console.log(JSON.stringify(body));
      let url = this.cmn.commonUrl + "financial/getPendingAssignmentTransferFeeInvoices.spring";
      console.log(url);
