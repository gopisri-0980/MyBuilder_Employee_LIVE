...
@Component({
  selector: 'app-all-notifications-view-details',
  templateUrl: './all-notifications-view-details.component.html',
  styleUrls: ['./all-notifications-view-details.component.sass']
})
export class AllNotificationsViewDetailsComponent implements OnInit {
  ...
  constructor(public route: ActivatedRoute, private router: Router, private http: Http, public cmn: CommonComponent) {
    ...
    sessionStorage.setItem("Title_name" , "View All Notifications");
