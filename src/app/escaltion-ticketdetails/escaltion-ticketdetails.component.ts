...
@Component({
  selector: 'app-escaltion-ticketdetails',
  templateUrl: './escaltion-ticketdetails.component.html',
  styleUrls: ['./escaltion-ticketdetails.component.sass']
})
export class EscaltionTicketdetailsComponent implements OnInit {
  ...
  constructor(private _router: Router, private deviceService: DeviceDetectorService, public route: ActivatedRoute, private router: Router, private http: Http, public cmn: CommonComponent) {
    ...
    this.ticketInfo_ticketdetailsId = json_response.ticketTypeDetailsId;
...
//alert(this.ticket_escalationdate)
    ...
    this.ticket_esclationId = json_response.ticketEscalationId;
  ...
  getTicketDetails() {
    ...
    var body = {
      ...
      "ticketTypeDetailsId": "" + this.ticketInfo_ticketdetailsId
    }
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        this.typeof_text = resp.ticketResponseList[0].department.typeOf;
        this.departmentId = resp.ticketResponseList[0].department.departmentId;
  ...
  myUpdate(ckeditor_msg) {
    ...
    this.preloader = true;
    var url = this.cmn.commonUrl + "employeeTicket/forwardTicketDetails.spring";
    //  var url;
    ...
    if (this.typeof_text == "EMPLOYEE") {
      body = {
        ...
        "ticketEscalationId": "" + this.ticket_esclationId,
        "type": "PM",
        "sessionKey": "" + sessionStorage.getItem("login_sessionkey")
      }
    } else {
