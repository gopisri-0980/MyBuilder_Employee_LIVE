...
@Component({
  selector: 'app-lender-creation',
  templateUrl: './lender-creation.component.html',
  styleUrls: ['./lender-creation.component.sass']
})
export class LenderCreationComponent implements OnInit {
  alias_name: any;
  name: any;
  address: any;
  mobileNumber: any;
