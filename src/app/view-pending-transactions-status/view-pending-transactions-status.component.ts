...
var Project_Id_back = []
var Transaction_set_off_data = [];

@Component({
  selector: 'app-view-pending-transactions-status',
  templateUrl: './view-pending-transactions-status.component.html',
  styleUrls: ['./view-pending-transactions-status.component.sass']
})
export class ViewPendingTransactionsStatusComponent implements OnInit {
  ...
  constructor(private cmn: CommonComponent, private http: Http, private router: Router, public fb: FormBuilder) {
    ...
    console.log(sessionStorage.getItem("view_pending_transaction_status"));

    if (sessionStorage.getItem("view_pending_transaction_status") == "true") {

      if (sessionStorage.getItem("back_Status") != null) {
        this.back_Status = sessionStorage.getItem("back_Status");
      }

      if (sessionStorage.getItem("back_trasactionfrom_date") != null) {
        var date = sessionStorage.getItem("back_trasactionfrom_date");
        var d = new Date(parseInt(date, 10));
        var datestring_from = d.getFullYear() + "-" + ("0" + (d.getMonth() + 1)).slice(-2) + "-" + ("0" + d.getDate()).slice(-2);
        $(function () {
          $("#fromDate").val(datestring_from);
        });
        this.back_trasactionfrom_date = sessionStorage.getItem("back_trasactionfrom_date");
      ...
      if (sessionStorage.getItem("back_trasactionto_date") != null) {

        var date1 = sessionStorage.getItem("back_trasactionto_date");
        ...
        this.back_trasactionto_date = sessionStorage.getItem("back_trasactionto_date");
      ...
      if (sessionStorage.getItem("back_receivedfrom_date") != null) {

        var date_rec = sessionStorage.getItem("back_receivedfrom_date");
        ...
        this.back_receivedfrom_date = sessionStorage.getItem("back_receivedfrom_date");
      ...
      if (sessionStorage.getItem("back_receivedto_date") != null) {

        var date_rec_to = sessionStorage.getItem("back_receivedfrom_date");
        ...
        this.back_receivedto_date = sessionStorage.getItem("back_receivedto_date");
      ...
      if (sessionStorage.getItem("back_setoff_type") != null) {
        this.back_setoff_type = sessionStorage.getItem("back_setoff_type");
      }

      if (sessionStorage.getItem("back_pendingat") != null) {
        this.back_pendingat = sessionStorage.getItem("back_pendingat");
      }

      if (sessionStorage.getItem("back_selected_projectid") != null) {
        this.back_selected_projectid = sessionStorage.getItem("back_selected_projectid");
      }

      if (sessionStorage.getItem("back_site_ac_number") != null) {
        site_ac_number = sessionStorage.getItem("back_site_ac_number");
      }

      if (sessionStorage.getItem("site_ac_name") != null) {
        site_ac_name = sessionStorage.getItem("site_ac_name");
      }
      ...
      if (sessionStorage.getItem("transaction_type_name") != null) {
        back_transaction_type_name = sessionStorage.getItem("transaction_type_name");
      }


      if (sessionStorage.getItem("transaction_mode_name") != null) {
        back_transaction_mode_name = sessionStorage.getItem("transaction_mode_name");
      }

      Transaction_set_off_back = [];
      if (sessionStorage.getItem("back_setoff_type") != undefined && sessionStorage.getItem("back_setoff_type") != "" && sessionStorage.getItem("back_setoff_type") != "select" && sessionStorage.getItem("back_setoff_type") != "undefined" && sessionStorage.getItem("back_setoff_type").length != 0) {

        Transaction_set_off_back = [];
        for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_setoff_type")).length; i++) {
          Transaction_set_off_back.push(JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].id);
        }
      } else {
        Transaction_set_off_back = [];
      }
      ...
      if (sessionStorage.getItem("back_site_ac_number") != undefined && sessionStorage.getItem("back_site_ac_number") != "" && sessionStorage.getItem("back_site_ac_number") != "select" && sessionStorage.getItem("back_site_ac_number") != "undefined" && sessionStorage.getItem("back_site_ac_number").length != 0) {
        Transaction_bank_account_back = [];
        for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_site_ac_number")).length; i++) {
          Transaction_bank_account_back.push(JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].id);
        }
      } else {
        Transaction_bank_account_back = [];
      }

      if (sessionStorage.getItem("back_selected_projectid") != undefined && sessionStorage.getItem("back_selected_projectid") != "" && sessionStorage.getItem("back_selected_projectid") != "select" && sessionStorage.getItem("back_selected_projectid") != "undefined" && sessionStorage.getItem("back_selected_projectid").length != 0) {
        Project_Id_back = [];
        for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_selected_projectid")).length; i++) {
          Project_Id_back.push(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].id);
        }
    ...
    } else if (this.view_clreared_transaction_data == null) {
      this.getPenidngTransactions("default", null, null, null, null, null, null, null, null, null);
    } else {
      this.getPenidngTransactions("clearedTransactionpage", null, null, null, null, null, null, null, null, null);
    }
  ...
  selectedSIDs(item: any) {
    ...
    if (this.project_list_item != undefined && this.project_list_item.length != 0 && this.project_list_item != null) {
      sessionStorage.setItem("back_selected_projectid", JSON.stringify(this.project_list_item));
    }
  ...
  company_selectedSIDs(item: any) {
    ...
    if (this.company_list_item != undefined && this.company_list_item.length != 0 && this.company_list_item != null) {
      sessionStorage.setItem("back_site_ac_number", JSON.stringify(this.company_list_item));
    }
  ...
  Transaction_set_off_selectedSIDs(item: any) {
    ...
    for (var i = 0; i < this.title3.length; i++) {
      Transaction_set_off_data.push(this.title3[i].id);
...
console.log(Transaction_set_off_data);
  ...
  getPenidngTransactions(status, trasactionfrom_date, trasactionto_date, receivedfrom_date, receivedto_date, setoff_type, pendingat, sitename, bankaccountno, bankaccountname) {
    ...
    console.log(status);
    console.log(trasactionfrom_date);
    console.log(trasactionto_date);

    console.log(receivedfrom_date);
    console.log(receivedto_date);
    console.log(setoff_type);
    ...
    if ($("#companybankAcId").val() == undefined && sessionStorage.getItem("back_site_ac_number") == null && sessionStorage.getItem("site_ac_name") == null) {
      site_ac_number = null;
      site_ac_name = null;
    } else {
      if ($("#companybankAcId").val() !== undefined && sessionStorage.getItem("back_site_ac_number") == null && sessionStorage.getItem("site_ac_name") == null) {

        if ($("#companybankAcId").val() == "select" && sessionStorage.getItem("back_site_ac_number") == null && sessionStorage.getItem("site_ac_name") == null) {
          site_ac_number = null;
          site_ac_name = null;
        } else {
      ...
      } else if ($("#companybankAcId").val() == undefined && sessionStorage.getItem("back_site_ac_number") != null && sessionStorage.getItem("site_ac_name") != null) {
        site_ac_number = sessionStorage.getItem("back_site_ac_number");
        site_ac_name = sessionStorage.getItem("site_ac_name");
      }
    ...
    console.log(sessionStorage.getItem("transaction_type_name"));
    console.log(sessionStorage.getItem("transaction_mode_name"));
    console.log($("#transaction_type").val());
    console.log($("#transaction_mode").val());


    if (sessionStorage.getItem("transaction_type_name") == null) {
      if ($("#transaction_type").val() == "" || $("#transaction_type").val() == "select" || $("#transaction_type").val() == undefined || $("#transaction_type").val() == null || $("#transaction_type").val() == "undefined") {
      ...
      this.transaction_type_name = sessionStorage.getItem("transaction_type_name");
    }
    ...
    if (sessionStorage.getItem("transaction_mode_name") == null) {
      ...
      if ($("#transaction_mode").val() == "" || $("#transaction_mode").val() == "select" || $("#transaction_mode").val() == undefined || $("#transaction_mode").val() == null || $("#transaction_mode").val() == "undefined") {
      ...
      this.transaction_mode_name = sessionStorage.getItem("transaction_mode_name");
    }
    ...
    if (this.view_clreared_transaction_data == null) {
      if (status == "search") {
        ...
        if (status != null) {
          sessionStorage.setItem("back_Status", status);
        }

        if (this.transaction_type_name != null) {
          sessionStorage.setItem("transaction_type_name", this.transaction_type_name);
        }

        if (this.transaction_mode_name != null) {
          sessionStorage.setItem("transaction_mode_name", this.transaction_mode_name);
        }

        if (trasactionfrom_date != null) {
          sessionStorage.setItem("back_trasactionfrom_date", trasactionfrom_date);
        }

        if (trasactionto_date != null) {
          sessionStorage.setItem("back_trasactionto_date", trasactionto_date);
        }

        if (receivedfrom_date != null) {
          sessionStorage.setItem("back_receivedfrom_date", receivedfrom_date);
        }

        if (receivedto_date != null) {
          sessionStorage.setItem("back_receivedto_date", receivedto_date);
        }


        if (pendingat != null) {
          sessionStorage.setItem("back_pendingat", pendingat);
        }

        // if (setoff_type != null) {
        //   sessionStorage.setItem("back_setoff_type", setoff_type);
        // }


        // if (sitename != null) {
        //   sessionStorage.setItem("back_selected_projectid", sitename);
        // }



        // if (bankaccountno != null) {
        //   sessionStorage.setItem("back_site_ac_number", bankaccountno);
        // }

        console.log(this.Transaction_set_List );

        if (this.Transaction_set_List != undefined && this.Transaction_set_List.length != 0 && this.Transaction_set_List != null) {
          sessionStorage.setItem("back_setoff_type", JSON.stringify(this.Transaction_set_List));
        }
        ...
        sessionStorage.setItem("view_pending_transaction_status", "true");
      ...
      body = {
        ...
        "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
        "condition": "transactionStatus",
        "trnCreatedFromDate": null,
        "trnCreatedTotoDate": null,
        "receivedFromDate": this.Clear_from_Date_value,
        "receivedToDate": this.Clear_to_Date_value,
        "pendingTrnByEmpId": null,
        "searchBySetOffType": null,
  ...
  searchFun() {
    ...
    if (sessionStorage.getItem("back_selected_projectid") == null && this.Projected_wise_data == null) {
      this.Projected_wise_data = null;
    } else if (sessionStorage.getItem("back_selected_projectid") == null && this.Projected_wise_data.length == 0) {
      this.Projected_wise_data = null;
    } else {
      this.Projected_wise_data = [];
      for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_selected_projectid")).length; i++) {
        this.Projected_wise_data.push(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].id);
      }

    }

    if (sessionStorage.getItem("back_site_ac_number") == null && this.Company_Bank_Account_wise == null) {
      this.Company_Bank_Account_wise = null;
    } else if (sessionStorage.getItem("back_site_ac_number") == null && this.Company_Bank_Account_wise.length == 0) {
      this.Company_Bank_Account_wise = null;
    } else {
      this.Company_Bank_Account_wise = [];
      for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_site_ac_number")).length; i++) {
        this.Company_Bank_Account_wise.push(JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].id);
      }
    ...
    console.log(sessionStorage.getItem("back_setoff_type"));

   
   // Transaction_set_off_data = [];
    if (sessionStorage.getItem("back_setoff_type") == null && Transaction_set_off_data == null) {
      Transaction_set_off_data = null;
    } else if (sessionStorage.getItem("back_setoff_type") == null && Transaction_set_off_data.length == 0) {
      Transaction_set_off_data = null;
    } else {
    //Transaction_set_off_data = [];
    if(sessionStorage.getItem("back_setoff_type") != null){
      ...
      for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_setoff_type")).length; i++) {
        Transaction_set_off_data.push(JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].id);
      }
    } else {
      Transaction_set_off_data = Transaction_set_off_data;
    }
    ...
    if (milliseconds_transaction_from == null && milliseconds_transaction_to == null && milliseconds_received_from == null
      && milliseconds_received_to == null && Transaction_set_off_data == null && pendingat == null &&
    ...
    //   this.Projected_wise_data == null && this.Company_Bank_Account_wise == null
    //   && this.transaction_type_name == null && this.transaction_mode_name == null) {
    //   swal("Please select a project before proceeding!");
    //   return false;
    // }
    ...
    this.getPenidngTransactions("search", milliseconds_transaction_from, milliseconds_transaction_to, milliseconds_received_from,
      milliseconds_received_to, Transaction_set_off_data, pendingat, this.Projected_wise_data, this.Company_Bank_Account_wise, this.account_name_company)
  }
  ...
  siteList() {
    ...
    this.http.post(url, body).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        console.log(sessionStorage.getItem("back_selected_projectid"));

        if (sessionStorage.getItem("back_selected_projectid") != null && sessionStorage.getItem("back_selected_projectid") != undefined && sessionStorage.getItem("back_selected_projectid").length != 0) {
          this.itemscc = [];
          for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_selected_projectid")).length; i++) {
            console.log(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].id);
            console.log(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].name);

            this.itemscc.push({
              id: parseInt(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].id),
              name: JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].name
            });

            this.project_wise_controller.push(JSON.parse(sessionStorage.getItem("back_selected_projectid"))[i].id);
          }
  ...
  projectchangeFun_remainDropdowndata(siteIds) {
    ...
    this.http.post(url, body).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        if (sessionStorage.getItem("back_setoff_type") != null && sessionStorage.getItem("back_setoff_type") != undefined && sessionStorage.getItem("back_setoff_type").length != 0) {
          this.itemssetoff = [];
          for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_setoff_type")).length; i++) {
            console.log(JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].id);
            console.log(JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].name);

            this.itemssetoff.push({
              key: JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].name,
              id: JSON.parse(sessionStorage.getItem("back_setoff_type"))[i].id
            });
        ...
        if (sessionStorage.getItem("back_pendingat") != null && sessionStorage.getItem("back_pendingat") != undefined && sessionStorage.getItem("back_pendingat") != 'select') {
          $('#pending_at').val(sessionStorage.getItem("back_pendingat"));
        }
  ...
  siteBankList(siteIds) {
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        console.log(sessionStorage.getItem("back_site_ac_number"));


        if (sessionStorage.getItem("back_site_ac_number") != null && sessionStorage.getItem("back_site_ac_number") != undefined && sessionStorage.getItem("back_site_ac_number").length != 0) {
          this.itemsbank = [];
          for (var i = 0; i < JSON.parse(sessionStorage.getItem("back_site_ac_number")).length; i++) {
            console.log(JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].id);
            console.log(JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].name);

            this.itemsbank.push({
              id: parseInt(JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].id),
              siteBankAccountNumber: JSON.parse(sessionStorage.getItem("back_site_ac_number"))[i].name
            });
          }
  ...
  transactionTypeAndMode() {
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        if (sessionStorage.getItem("transaction_type_name") != undefined && sessionStorage.getItem("transaction_type_name") != "undefined" && sessionStorage.getItem("transaction_type_name") != "" && sessionStorage.getItem("transaction_type_name") != "select") {
          Transaction_type_back = sessionStorage.getItem("transaction_type_name");
          $("#transaction_type").val(Transaction_type_back);
        }

        if (sessionStorage.getItem("transaction_mode_name") != undefined && sessionStorage.getItem("transaction_mode_name") != "undefined" && sessionStorage.getItem("transaction_mode_name") != "" && sessionStorage.getItem("transaction_mode_name") != "select") {
          Transaction_Mode_back = sessionStorage.getItem("transaction_mode_name");
