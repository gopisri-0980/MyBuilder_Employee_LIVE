...
export class ViewAssignmentTransferFeeService {
  ...
  getModificationInvoice(siteId, bookingfromid, finbookingmodicostid): Promise<any> {
    return new Promise((resolve, reject) => {
      var body = {
        ...
        "finBookingFormAssignmentTransferFeeId": finbookingmodicostid,
        "requestUrl": "carAssignmentTransferFeeDetailsPage"
      }


      let url = this.cmn.commonUrl + "financial/getAssignmentTransferFeeInvoiceDetails.spring";
      console.log(url);
  ...
  getApprovemodificationinvoice(siteid, empId, sitename , finBookingFormModiCostId, finsetOffAppLevelId, 
    ...
    return new Promise((resolve, reject) => {
      ...
      var body = {
        ...
        "siteId": siteid,
        "siteName": sitename,
        "finBookingFormAssignmentTransferFeeId": finBookingFormModiCostId,
        ...
        "assignmentTransferFeeDtlsRequests":modiCostDtlsRequests,
        "comment": null,
        "siteAccountId": null,
      ...
      let url = this.cmn.commonUrl + "financial/approveAssignmentTransferFeeEntry.spring";
      console.log(url);
