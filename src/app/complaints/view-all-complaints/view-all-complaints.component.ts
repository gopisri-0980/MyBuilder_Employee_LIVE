...
@Component({
  ...
  styleUrls: ['./view-all-complaints.component.sass']
})
export class ViewAllComplaintsComponent implements OnInit {
  ...
  constructor(private deviceService: DeviceDetectorService, private router: Router, private http: Http, public cmn: CommonComponent) {
   ...
   // this.siteList_temp();
    this.isButtonClicked = sessionStorage.getItem('isBackButton_Clicked_viewallcmplnts');
    console.log(this.isButtonClicked);
    sessionStorage.getItem("site_idd_allcomplaints");
    sessionStorage.getItem("fromdatee");
    sessionStorage.getItem("todatee");
    sessionStorage.getItem("mystaus_val");


    console.log(sessionStorage.getItem("site_idd_allcomplaints"));
      console.log(sessionStorage.getItem("fromdatee"));
      console.log(sessionStorage.getItem("todatee"));
      console.log(sessionStorage.getItem("site_idd_allcomplaints"));
      console.log(sessionStorage.getItem("fromdatee"));
      console.log(sessionStorage.getItem("todatee"));
      console.log(sessionStorage.getItem("mystaus_val"));
      console.log("----"+sessionStorage.getItem('sessionpageNo'))

    if (sessionStorage.getItem("forsessionvalues") == "true" ) {

   
   this.sitelist();
      this.getTicketList_fromsession();
    
    //  this.customernamelist(sessionStorage.getItem("site_idd_allcomplaints"))
      // this.pageChanged_backbutton(sessionStorage.getItem('sessionpageNo'));
    } else {
      this.sitelist();
      this.getTicketList1();
      //sessionStorage.setItem("site_idd_allcomplaints", '');
  ...
  gotoTicketDetailspage(data, index) {
    ...
    sessionStorage.getItem("todatee");
    sessionStorage.getItem("mystaus_val");
    sessionStorage.setItem("common_for_flats", "View-All-Complaints");
 ...
 //   sessionStorage.setItem("Totalticketdata", this.ticketListtotaldata);
    this.router.navigate(["Complaints-view-details"], { state: this.viewticketData });
  ...
  getTicketList_fromsession() {
    ...
    var fromdate;
    var flatbooking_Iddv_allcomplaints
    var todatee;
    var Ticketnumberr;
     var site_idd_allcomplaints 
    

    if(sessionStorage.getItem("site_idd_allcomplaints") == "null"){
      site_idd_allcomplaints = null
    }else{
      site_idd_allcomplaints = [sessionStorage.getItem("site_idd_allcomplaints")]
    }
if(sessionStorage.getItem("fromdatee") == "null" || sessionStorage.getItem("fromdatee") == ""){
  fromdate = null
}else{
  fromdate = sessionStorage.getItem("fromdatee")
}

if(sessionStorage.getItem("todatee") == "null" || sessionStorage.getItem("todatee") == ""){
  todatee = null
}else{
  todatee = sessionStorage.getItem("todatee")
}
if(sessionStorage.getItem("flatbooking_Iddv_allcomplaints") == "null"){
  flatbooking_Iddv_allcomplaints = null
}else{
  flatbooking_Iddv_allcomplaints = sessionStorage.getItem("flatbooking_Iddv_allcomplaints")
}

if(sessionStorage.getItem("Ticketnumberr") == "null"){
  Ticketnumberr = null
}else{
  Ticketnumberr = sessionStorage.getItem("Ticketnumberr")
}
    let url = this.cmn.commonUrl + "employeeComplaint/getComplaintList.spring"
    let headers = new Headers({ 'Content-Type': 'application/json' });
    let options = new RequestOptions({ headers: headers });
    var body = {
      
      "requestUrl": "getComplaints/AllComplaints",
      "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
      
      "startDate": fromdate, //"2020-05-20",
      "endDate":todatee, //"2020-05-21",
      "siteIds": site_idd_allcomplaints,  //sessionStorage.getItem("site_idd"),
      "flatBookingId": flatbooking_Iddv_allcomplaints,
      "complaintId": Ticketnumberr,
      "requestEnum": null
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        this.forslideData = resp.complaintResponseList;
 ...
 //       $(".page-loader-wrapper").hide();
  ...
  //   $(".page-loader-wrapper").show();
  //   let url = this.cmn.commonUrl + "employeeComplaint/getTicketList.spring";
  //   let headers = new Headers({ 'Content-Type': 'application/json' });
  //   let options = new RequestOptions({ headers: headers });
  //   var body = {
  //     // "employeeId":""+sessionStorage.getItem('session_empid'),
  ...
  sitelist() {
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      if (resp.responseCode == 200) {
        ...
        if (sessionStorage.getItem("site_idd_allcomplaints") == "" || sessionStorage.getItem("site_idd_allcomplaints") == null || sessionStorage.getItem("site_idd_allcomplaints") == "null") {
        } else {
          $("#siteID").val(sessionStorage.getItem("site_idd_allcomplaints"));
  ...
  customernamelist(siteidd) {
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        console.log(sessionStorage.getItem("flatbooking_Iddv_allcomplaints"));
       
        if (sessionStorage.getItem("flatbooking_Iddv_allcomplaints") == "" || sessionStorage.getItem("flatbooking_Iddv_allcomplaints") == null || sessionStorage.getItem("flatbooking_Iddv_allcomplaints") == "null") {
        } else {
          $("#customerID").val(sessionStorage.getItem("flatbooking_Iddv_allcomplaints"));
        }
  ...
  searchviewallticketList() {
    ...
    sessionStorage.setItem("site_idd_allcomplaints", site_idd);
    sessionStorage.setItem("fromdatee", fromdatee);
    sessionStorage.setItem("todatee", todatee);
    sessionStorage.setItem("mystaus_val", mystaus_val);
    sessionStorage.setItem("Ticketnumberr", Ticket_number);
    sessionStorage.setItem("flatbooking_Iddv_allcomplaints", flatbooking_Id);
    ...
    var body = {
      ...
      "startDate": fromdatee, //"2020-05-20",
      "endDate": todatee, //"2020-05-21",
      "ComplaintStatusIds": mystaus_val,
      "siteIds": site_idd,
      "flatBookingId": flatbooking_Id,
      "complaintId": Ticket_number,
      "requestEnum": null
...
console.log(JSON.stringify(body))
  ...
  showallfun() {
    ...
    sessionStorage.removeItem("site_idd_allcomplaints");
    ...
    sessionStorage.removeItem("flatbooking_Iddv_allcomplaints")
