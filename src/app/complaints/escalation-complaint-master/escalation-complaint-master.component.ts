...
@Component({
  selector: 'app-escalation-complaint-master',
  templateUrl: './escalation-complaint-master.component.html',
  styleUrls: ['./escalation-complaint-master.component.sass']
})
export class EscalationComplaintMasterComponent implements OnInit {
  ...
  addRow(index) {
    ...
    if (this.select_Ticket_Level == undefined || this.select_Ticket_Level == "undefined" || this.select_Ticket_Level == null) {
      swal("Please select the complaint leavel.");
      return false;
    }
  ...
  getEscalationLevel() {
    ...
    $('.page-loader-wrapper').show();
    let url = this.cmn.commonUrl + "employeeComplaint/getEscalationLevel.spring";
    let headers = new Headers({ 'Content-Type': 'application/json' });
    var body = {
      "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
  ...
  ticketchangeFun(event) {
    ...
    $('.page-loader-wrapper').show();
    let url = this.cmn.commonUrl + "employeeComplaint/getEscalationLevelEmployees.spring";
    let headers = new Headers({ 'Content-Type': 'application/json' });
    var body = {
      "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
  ...
  submitfunction() {
    ...
    if (confirm("Do you really want to Submit ?")) {
      ...
      $('.page-loader-wrapper').show();
      //http://localhost:8888/SumadhuraGateway/employeeservice/employeeComplaint/createComplaintEscalationsLevels.spring
      let url = this.cmn.commonUrl + "employeeComplaint/createComplaintEscalationsLevels.spring";
      let headers = new Headers({ 'Content-Type': 'application/json' });
      var body = {
        "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
        "siteId": $("#projectID").val(),
        ...
        "complaintEscalationRequest": [
          {
            "complaintEscalationLevelRequestList": this.controller_data,
            "complaintType": this.controller
          }
        ]
      }
