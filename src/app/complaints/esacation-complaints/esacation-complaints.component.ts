...
@Component({
  selector: 'app-esacation-complaints',
  templateUrl: './esacation-complaints.component.html',
  styleUrls: ['./esacation-complaints.component.sass']
})
export class EsacationComplaintsComponent implements OnInit {
  ...
  ngAfterViewInit() {
    $('#tableSelect').on('change', (event) => {
      ...
      let url = this.cmn.commonUrl + "employeeComplaint/getSystemEscalatedComplaintDetails.spring";
      ...
      if ($("#tableSelect").val() == "All") {
        ...
        body = {
          "requestUrl": "getSystemEscalatedComplaintDetails.spring",
      ...
      this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
        ...
        if (resp.responseCode == 200) {
          ...
          if ($("#tableSelect").val() == "All") {
            ...
            this.totalItems = resp.complaintResponseList.length;
          
            this.itemsPer_Page = resp.complaintResponseList.length;
  ...
  gotoTicketDetailspage(data) {
    ...
    this.router.navigate(["Escalation_Complaints_Details"], { state: this.viewticketData });
...
console.log(JSON.stringify(body));
    ...
    this.http.post(url, body, options).map(res => res.json()).subscribe(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        this.total_length = resp.complaintResponseList;
