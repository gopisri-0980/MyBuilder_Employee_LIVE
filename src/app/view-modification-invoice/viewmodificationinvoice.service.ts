...
export class ViewmodificationinvoiceService {
  ...
  getModificationInvoice(siteId, bookingfromid, finbookingmodicostid): Promise<any> {
    return new Promise((resolve, reject) => {
      var body = {
        ...
        "finBookingFormModiCostId": finbookingmodicostid,
        "requestUrl": "modificationInvoiceDetailsPage"
      }

      console.log(body);
      let url = this.cmn.commonUrl + "financial/getModificationInvoiceDetails.spring";
      console.log(url);
