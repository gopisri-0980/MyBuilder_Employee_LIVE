...
@Component({
  selector: 'app-horizon-customer',
  templateUrl: './horizon-customer.component.html',
  styleUrls: ['./horizon-customer.component.sass']
})
export class HorizonCustomerComponent implements OnInit {
  ...
  filesubmit() {
    ...
    console.log(Scheme_XLSXData1);
    console.log(Block_A_DN_XLSXData2);
    console.log(Block_A_TRN_XLSXData3);


    if (Scheme_XLSXData1.length == 0 || (Block_A_TRN_XLSXData3.length == 0)) {
...
console.log(Block_A_TRN_XLSXData3[i].ONLINE_TR_REFERENCE_NO );
      ...
      if (Block_A_TRN_XLSXData3[i].PRINCIPAL_AMOUNT == null) {
        Block_A_TRN_XLSXData3[i].PRINCIPAL_AMOUNT = 0;
      }
      ...
      // if (Block_A_TRN_XLSXData3[i].ONLINE_TR_RECEIVE_DATE == "" || Block_A_TRN_XLSXData3[i].ONLINE_TR_RECEIVE_DATE == "N/A"|| Block_A_TRN_XLSXData3[i].ONLINE_TR_RECEIVE_DATE == null) {
      ...
      var cheque_date;
      if (Block_A_TRN_XLSXData3[i].CHEQUE_DATE == "" || Block_A_TRN_XLSXData3[i].CHEQUE_DATE == "N/A" || Block_A_TRN_XLSXData3[i].CHEQUE_DATE == null) {
      ...
      var  waived_off_date;
      if (Block_A_TRN_XLSXData3[i].WAIVED_OFF_DATE == "" || Block_A_TRN_XLSXData3[i].WAIVED_OFF_DATE == "N/A") {
      ...
      console.log(Block_A_TRN_XLSXData3[i].TRANSACTION_MODE);
      ...
      var demandNotetransactionrequests = {
        ...
        "paymentSetOffDetails": [{ "setOffTypeName": "Fin_Booking_Form_Milestones", "amount": principle_updatetds_amount }
          ...
          , { "setOffTypeName": "Modification_Cost", "amount": modification_cost, "invoiceNo": "" }
          , { "setOffTypeName": "Legal_Cost", "amount": legal_cost, "invoiceNo": "" }
         , { "setOffTypeName": "Car_Parking_Cost", "amount": Car_parking_cost, "invoiceNo": "" }

         , { "setOffTypeName": "Assignment_Transfer_Fee", "amount": Assignment_cost, "invoiceNo": "" }
